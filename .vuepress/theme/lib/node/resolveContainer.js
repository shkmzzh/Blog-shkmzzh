...
exports.resolveContainerOptions = exports.resolveOptionsForCodeGroupItem = exports.resolveOptionsForCodeGroup = void 0;
...
exports.resolveOptionsForCodeGroup = resolveOptionsForCodeGroup;
...
exports.resolveOptionsForCodeGroupItem = resolveOptionsForCodeGroupItem;
const resolveContainerOptions = (type) => {
    ...
    if (type === 'code-group') {
        return { type, ...exports.resolveOptionsForCodeGroup() };
    }
    if (type === 'code-group-item') {
        return { type, ...exports.resolveOptionsForCodeGroupItem() };
    }
    return { type, render };
};
exports.resolveContainerOptions = resolveContainerOptions;
